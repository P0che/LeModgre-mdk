...
import net.poche.modgre.screen.inventory.container.CustomInventoryMenu;
import org.joml.Matrix4f;
import org.joml.Quaternionf;

import javax.annotation.Nullable;

public class AnotherCustomInventoryScreen extends EffectRenderingInventoryScreen<CustomInventoryMenu> {
    ...
    public AnotherCustomInventoryScreen(Player pPlayer) {
        super(new CustomInventoryMenu(MenuType.GENERIC_9x1,0), pPlayer.getInventory(), Component.translatable("container.crafting"));
        this.titleLabelX = 97;
    }
